...
import com.example.android.ideation.bookCity.BookDetail;
...
public class BooksAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder.getItemViewType() == BOOK_MORE) {
            ...
            ((BookViewHolder) holder).descView.setText(books.get(position).getBook_description());
            ((BookViewHolder) holder).titleView.setText(books.get(position).getBook_title());
            ((BookViewHolder) holder).typeView.setText(books.get(position).getBook_type());
            if (books.get(position).getBook_price() != null && !books.get(position).getBook_price().equals("")) {
                ((BookViewHolder) holder).priceView.setText(books.get(position).getBook_price() + "RS/-");
            }else{
            ...
            ((BookViewHolder) holder).layout.setOnClickListener(new View.OnClickListener() {
                @Override
