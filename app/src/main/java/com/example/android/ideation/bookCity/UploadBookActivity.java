package com.example.android.ideation.bookCity;
...
import com.example.android.ideation.model.Book;
import com.example.android.ideation.utils.DBOperations;
...
public class UploadBookActivity extends AppCompatActivity {
    ...
    private void initMultiSpinner() {
        if (multiArrayList == null) {
            ...
            multiArrayList.add(new MultiSelectModel(0, "AGRICULTURE AND ALLIED INDUSTRIES"));
            multiArrayList.add(new MultiSelectModel(1, "AUTOMOBILES"));
            multiArrayList.add(new MultiSelectModel(2, "AUTO COMPONENTS"));
            multiArrayList.add(new MultiSelectModel(3, "BANKING"));
            multiArrayList.add(new MultiSelectModel(4, "BIOTECHNOLOGY"));
            multiArrayList.add(new MultiSelectModel(5, "CEMENT"));
            multiArrayList.add(new MultiSelectModel(6, "CONSUMER DURABLES"));
            multiArrayList.add(new MultiSelectModel(7, "DEFENCE MANUFACTURING"));
            multiArrayList.add(new MultiSelectModel(8, "E-COMMERCE"));
            multiArrayList.add(new MultiSelectModel(9, "EDUCATION AND TRAINING"));
            multiArrayList.add(new MultiSelectModel(10, "ENGINEERING AND CAPITAL GOODS"));
            multiArrayList.add(new MultiSelectModel(11, "ELECTRONICS SYSTEM DESIGN & MANUFACTURING"));
            multiArrayList.add(new MultiSelectModel(12, "FINANCIAL SERVICES"));
            multiArrayList.add(new MultiSelectModel(13, "FMCG"));
            multiArrayList.add(new MultiSelectModel(14, "GEMS AND JEWELLERY"));
            multiArrayList.add(new MultiSelectModel(15, "HEALTHCARE"));
            multiArrayList.add(new MultiSelectModel(16, "INFRASTRUCTURE"));
            multiArrayList.add(new MultiSelectModel(17, "INSURANCE"));
            multiArrayList.add(new MultiSelectModel(18, "IT AND BPM"));
            multiArrayList.add(new MultiSelectModel(19, "MANUFACTURING"));
            multiArrayList.add(new MultiSelectModel(20, "MEDIA AND ENTERTAINMENT"));
            multiArrayList.add(new MultiSelectModel(21, "MEDICAL DEVICES"));
            multiArrayList.add(new MultiSelectModel(22, "METALS AND MINING"));
            multiArrayList.add(new MultiSelectModel(23, "OIL AND GAS"));
            multiArrayList.add(new MultiSelectModel(24, "PHARMACEUTICALS"));
            multiArrayList.add(new MultiSelectModel(25, "PORTS"));
            multiArrayList.add(new MultiSelectModel(26, "POWER"));
            multiArrayList.add(new MultiSelectModel(27, "RAILWAYS"));
            multiArrayList.add(new MultiSelectModel(28, "REAL ESTATE"));
            multiArrayList.add(new MultiSelectModel(29, "RENEWABLE ENERGY"));
            multiArrayList.add(new MultiSelectModel(30, "RETAIL"));
            multiArrayList.add(new MultiSelectModel(31, "ROADS"));
            multiArrayList.add(new MultiSelectModel(32, "SCIENCE AND TECHNOLOGY"));
            multiArrayList.add(new MultiSelectModel(33, "SERVICES"));
            multiArrayList.add(new MultiSelectModel(34, "STEEL"));
            multiArrayList.add(new MultiSelectModel(35, "TELECOMMUNICATIONS"));
            multiArrayList.add(new MultiSelectModel(36, "TEXTILES"));
            multiArrayList.add(new MultiSelectModel(37, "TOURISM AND HOSPITALITY"));
